...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/$domain_without_protocol/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/$domain_without_protocol/privkey.pem;
